...
int main() {
  ...
  //   auto glossy_mat =
  //       std::make_shared<material::GlossyPlastic>(Vec3(0.1f, 0.6f, 0.9f),
  //       0.15f);
  ...
  //   auto sphere = std::make_shared<geometry::Sphere>(lookat - 2 * u *
  //   spacing, r,
  //                                                    cloth_mat);
  //   auto plastic_sphere =
  //       std::make_shared<geometry::Sphere>(lookat - u * spacing, r,
  //       opaque_mat);
  //   auto glossy_sphere =
