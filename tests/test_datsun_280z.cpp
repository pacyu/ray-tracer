...
int main() {
  ...
  auto light = std::make_shared<geometry::Sphere>(Vec3(0.0f, 2000.0f, 3000.0f),
                                                  30.0f, sun_mat);
  ...
  Camera camera(image_width, image_height, samples_per_pixel, max_depth,
                "test_datsun_280z.png", background, lookfrom, lookat, vup,
                90.0f);
